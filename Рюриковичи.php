...
//     (comic_id, comic_chapter_name, comic_chapter_img)
//     VALUES 
//     (2, 'Глава 1', './img/chapters/chapter.png')
//     "
// );
...
<body>
    ...
    <?php
        $res = $pdo->prepare("SELECT id, comic_chapter_name, comic_chapter_img FROM chapters WHERE comic_id = 1");
        $res->execute();
            ...
            <div class="chapters__block-list">
                <div class="block-list__container">
                    ...
                    <?php
                        ...
                        echo '<a class="chapters__link" href="./comics.php?id=' . $chapter['id'] . '&theme=1">' . $chapter['comic_chapter_name'] . '</a>';
                        echo '</li>';
                        }
                    ?>
                    </ol>
